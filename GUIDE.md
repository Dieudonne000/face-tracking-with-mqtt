...
```bash
mosquitto_sub -h 127.0.0.1 -t "vision/teamalpha/movement" -v
```

**Terminal 2:**

```bash
mosquitto_pub -h 127.0.0.1 -t "vision/teamalpha/movement" -m '{"status":"MOVE_LEFT","confidence":0.87,"timestamp":1730000000}'
```
...
You should see WiFi and MQTT connect, and “subscribed to: vision/teamalpha/movement”. In another terminal:

```bash
mosquitto_pub -h 127.0.0.1 -t "vision/teamalpha/movement" -m '{"status":"MOVE_LEFT","confidence":0.9,"timestamp":1730000000}'
```
